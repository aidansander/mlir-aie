...
define dso_local void @dut(ptr noalias nocapture readonly %0, ptr noalias nocapture writeonly %1) local_unnamed_addr #2 {
  %3 = getelementptr bfloat, ptr %0, i20 -16
  %4 = tail call noundef <16 x i32> @llvm.aie2.v16int32()
  %5 = tail call noundef <16 x i32> @llvm.aie2.vbroadcast32.I512(i32 1023)
  %6 = tail call noundef <16 x i32> @llvm.aie2.vbroadcast32.I512(i32 0)
  %7 = tail call noundef <16 x bfloat> @llvm.aie2.v16bfloat16()
  %8 = tail call noundef <8 x i64> @llvm.aie2.v16accfloat()
  %9 = getelementptr bfloat, ptr %1, i20 -16
  %10 = zext i20 ptrtoint (ptr @exp_ilut_ab to i20) to i32
  %11 = zext i20 ptrtoint (ptr @exp_ilut_cd to i20) to i32
  %12 = zext i20 ptrtoint (ptr @exp_flut_ab to i20) to i32
  %13 = zext i20 ptrtoint (ptr @exp_flut_cd to i20) to i32
  br label %15
...
15:                                               ; preds = %15, %2
  %16 = phi i32 [ 1024, %2 ], [ %134, %15 ]
  %17 = trunc i32 %16 to i20
  %18 = getelementptr bfloat, ptr %3, i20 %17
  %19 = load <16 x bfloat>, ptr %18, align 32, !tbaa !12
  %20 = tail call noundef <16 x i32> @llvm.aie2.v16bf16.to.v16i32(<16 x bfloat> %19, i32 8)
  %21 = tail call noundef <32 x i16> @llvm.aie2.v32int16()
  %22 = bitcast <32 x i16> %21 to <16 x i32>
  %23 = tail call <16 x i32> @llvm.aie2.vshuffle(<16 x i32> %20, <16 x i32> %22, i32 2)
  %24 = tail call <8 x i32> @llvm.aie2.ext.I256.I512(<16 x i32> %23, i32 0)
  %25 = bitcast <8 x i32> %24 to <16 x i16>
  ...
  %30 = tail call noundef <16 x i32> @llvm.aie2.vbroadcast32.I512(i32 %10)
  %31 = tail call noundef <16 x i32> @llvm.aie2.vbroadcast32.I512(i32 %11)
  %32 = tail call noundef <16 x i32> @llvm.aie2.vsel32(<16 x i32> %30, <16 x i32> %31, i32 52428)
  %33 = add <16 x i32> %32, %29
  %34 = tail call <8 x i32> @llvm.aie2.ext.I256.I512(<16 x i32> %33, i32 0)
  %35 = tail call noundef <8 x i32> @llvm.aie2.load.4x16.lo(<8 x i32> %34), !noalias !15
  %36 = tail call <16 x i32> @llvm.aie2.upd.I512.I256(<16 x i32> undef, <8 x i32> %35, i32 0)
  %37 = tail call noundef <8 x i32> @llvm.aie2.load.4x16.hi(<8 x i32> %34), !noalias !15
  %38 = tail call <16 x i32> @llvm.aie2.upd.I512.I256(<16 x i32> %36, <8 x i32> %37, i32 1)
  %39 = tail call <8 x i32> @llvm.aie2.ext.I256.I512(<16 x i32> %33, i32 1)
  %40 = tail call noundef <8 x i32> @llvm.aie2.load.4x16.lo(<8 x i32> %39), !noalias !15
  %41 = tail call <16 x i32> @llvm.aie2.upd.I512.I256(<16 x i32> undef, <8 x i32> %40, i32 0)
  %42 = tail call noundef <8 x i32> @llvm.aie2.load.4x16.hi(<8 x i32> %39), !noalias !15
  %43 = tail call <16 x i32> @llvm.aie2.upd.I512.I256(<16 x i32> %41, <8 x i32> %42, i32 1)
  %44 = tail call <16 x i32> @llvm.aie2.vshuffle(<16 x i32> %38, <16 x i32> %43, i32 24)
  %45 = bitcast <16 x i32> %44 to <32 x bfloat>
  %46 = tail call <16 x bfloat> @llvm.aie2.ext.bf256.bf512(<32 x bfloat> %45, i32 0)
  %47 = tail call noundef <16 x i32> @llvm.aie2.I512.v16.acc64.srs(<16 x i64> %28, i32 -2, i32 1)
  %48 = and <16 x i32> %47, %5
  %49 = tail call noundef <16 x i32> @llvm.aie2.vbroadcast32.I512(i32 %12)
  %50 = tail call noundef <16 x i32> @llvm.aie2.vbroadcast32.I512(i32 %13)
  %51 = tail call noundef <16 x i32> @llvm.aie2.vsel32(<16 x i32> %49, <16 x i32> %50, i32 52428)
  %52 = add <16 x i32> %51, %48
  %53 = tail call <8 x i32> @llvm.aie2.ext.I256.I512(<16 x i32> %52, i32 0)
  %54 = tail call noundef <8 x i32> @llvm.aie2.load.4x16.lo(<8 x i32> %53), !noalias !20
  %55 = tail call <16 x i32> @llvm.aie2.upd.I512.I256(<16 x i32> undef, <8 x i32> %54, i32 0)
  %56 = tail call noundef <8 x i32> @llvm.aie2.load.4x16.hi(<8 x i32> %53), !noalias !20
  ...
  %59 = tail call noundef <8 x i32> @llvm.aie2.load.4x16.lo(<8 x i32> %58), !noalias !20
  %60 = tail call <16 x i32> @llvm.aie2.upd.I512.I256(<16 x i32> undef, <8 x i32> %59, i32 0)
  %61 = tail call noundef <8 x i32> @llvm.aie2.load.4x16.hi(<8 x i32> %58), !noalias !20
  ...
  %66 = tail call noundef <32 x bfloat> @llvm.aie2.vbroadcast16.bf512(bfloat 0xR0000)
  %67 = tail call <16 x bfloat> @llvm.aie2.ext.bf256.bf512(<32 x bfloat> %66, i32 0)
  %68 = tail call <32 x bfloat> @llvm.aie2.set.bf512.bf256(<16 x bfloat> %46, i32 0)
  %69 = tail call <32 x bfloat> @llvm.aie2.upd.bf512.bf256(<32 x bfloat> %68, <16 x bfloat> %67, i32 1)
  %70 = tail call <32 x bfloat> @llvm.aie2.set.bf512.bf256(<16 x bfloat> %65, i32 0)
  %71 = tail call <32 x bfloat> @llvm.aie2.upd.bf512.bf256(<32 x bfloat> %70, <16 x bfloat> %67, i32 1)
  %72 = tail call noundef <8 x i64> @llvm.aie2.bf.mul16.conf(<32 x bfloat> %69, <32 x bfloat> %71, i32 60)
  %73 = tail call noundef <16 x bfloat> @llvm.aie2.v16accfloat.to.v16bf16(<8 x i64> %72)
  %74 = getelementptr bfloat, ptr %9, i20 %17
  store <16 x bfloat> %73, ptr %74, align 32, !tbaa !12
  %75 = add i32 %16, 1048560
  %76 = trunc i32 %75 to i20
  %77 = getelementptr bfloat, ptr %3, i20 %76
  %78 = load <16 x bfloat>, ptr %77, align 32, !tbaa !12
  %79 = tail call noundef <16 x i32> @llvm.aie2.v16bf16.to.v16i32(<16 x bfloat> %78, i32 8)
  %80 = tail call noundef <32 x i16> @llvm.aie2.v32int16()
  %81 = bitcast <32 x i16> %80 to <16 x i32>
  %82 = tail call <16 x i32> @llvm.aie2.vshuffle(<16 x i32> %79, <16 x i32> %81, i32 2)
  %83 = tail call <8 x i32> @llvm.aie2.ext.I256.I512(<16 x i32> %82, i32 0)
  %84 = bitcast <8 x i32> %83 to <16 x i16>
  %85 = tail call noundef <32 x bfloat> @llvm.aie2.v32bfloat16()
  %86 = tail call noundef <16 x i64> @llvm.aie2.v16acc64()
  %87 = tail call noundef <16 x i64> @llvm.aie2.acc64.v16.I256.ups(<16 x i16> %84, i32 0, i32 0)
  %88 = tail call noundef <16 x i32> @llvm.aie2.I512.v16.acc64.srs(<16 x i64> %87, i32 6, i32 1)
  %89 = tail call noundef <16 x i32> @llvm.aie2.vbroadcast32.I512(i32 %10)
  %90 = tail call noundef <16 x i32> @llvm.aie2.vbroadcast32.I512(i32 %11)
  %91 = tail call noundef <16 x i32> @llvm.aie2.vsel32(<16 x i32> %89, <16 x i32> %90, i32 52428)
  %92 = add <16 x i32> %91, %88
  %93 = tail call <8 x i32> @llvm.aie2.ext.I256.I512(<16 x i32> %92, i32 0)
  %94 = tail call noundef <8 x i32> @llvm.aie2.load.4x16.lo(<8 x i32> %93), !noalias !15
  %95 = tail call <16 x i32> @llvm.aie2.upd.I512.I256(<16 x i32> undef, <8 x i32> %94, i32 0)
  %96 = tail call noundef <8 x i32> @llvm.aie2.load.4x16.hi(<8 x i32> %93), !noalias !15
  ...
  %99 = tail call noundef <8 x i32> @llvm.aie2.load.4x16.lo(<8 x i32> %98), !noalias !15
  %100 = tail call <16 x i32> @llvm.aie2.upd.I512.I256(<16 x i32> undef, <8 x i32> %99, i32 0)
  %101 = tail call noundef <8 x i32> @llvm.aie2.load.4x16.hi(<8 x i32> %98), !noalias !15
  ...
  %106 = tail call noundef <16 x i32> @llvm.aie2.I512.v16.acc64.srs(<16 x i64> %87, i32 -2, i32 1)
  %107 = and <16 x i32> %106, %5
  %108 = tail call noundef <16 x i32> @llvm.aie2.vbroadcast32.I512(i32 %12)
  %109 = tail call noundef <16 x i32> @llvm.aie2.vbroadcast32.I512(i32 %13)
  %110 = tail call noundef <16 x i32> @llvm.aie2.vsel32(<16 x i32> %108, <16 x i32> %109, i32 52428)
  %111 = add <16 x i32> %110, %107
  %112 = tail call <8 x i32> @llvm.aie2.ext.I256.I512(<16 x i32> %111, i32 0)
  %113 = tail call noundef <8 x i32> @llvm.aie2.load.4x16.lo(<8 x i32> %112), !noalias !20
  %114 = tail call <16 x i32> @llvm.aie2.upd.I512.I256(<16 x i32> undef, <8 x i32> %113, i32 0)
  %115 = tail call noundef <8 x i32> @llvm.aie2.load.4x16.hi(<8 x i32> %112), !noalias !20
  %116 = tail call <16 x i32> @llvm.aie2.upd.I512.I256(<16 x i32> %114, <8 x i32> %115, i32 1)
  %117 = tail call <8 x i32> @llvm.aie2.ext.I256.I512(<16 x i32> %111, i32 1)
  %118 = tail call noundef <8 x i32> @llvm.aie2.load.4x16.lo(<8 x i32> %117), !noalias !20
  %119 = tail call <16 x i32> @llvm.aie2.upd.I512.I256(<16 x i32> undef, <8 x i32> %118, i32 0)
  %120 = tail call noundef <8 x i32> @llvm.aie2.load.4x16.hi(<8 x i32> %117), !noalias !20
  %121 = tail call <16 x i32> @llvm.aie2.upd.I512.I256(<16 x i32> %119, <8 x i32> %120, i32 1)
  %122 = tail call <16 x i32> @llvm.aie2.vshuffle(<16 x i32> %116, <16 x i32> %121, i32 24)
  %123 = bitcast <16 x i32> %122 to <32 x bfloat>
  %124 = tail call <16 x bfloat> @llvm.aie2.ext.bf256.bf512(<32 x bfloat> %123, i32 0)
  %125 = tail call noundef <32 x bfloat> @llvm.aie2.vbroadcast16.bf512(bfloat 0xR0000)
  %126 = tail call <16 x bfloat> @llvm.aie2.ext.bf256.bf512(<32 x bfloat> %125, i32 0)
  %127 = tail call <32 x bfloat> @llvm.aie2.set.bf512.bf256(<16 x bfloat> %105, i32 0)
  %128 = tail call <32 x bfloat> @llvm.aie2.upd.bf512.bf256(<32 x bfloat> %127, <16 x bfloat> %126, i32 1)
  %129 = tail call <32 x bfloat> @llvm.aie2.set.bf512.bf256(<16 x bfloat> %124, i32 0)
  %130 = tail call <32 x bfloat> @llvm.aie2.upd.bf512.bf256(<32 x bfloat> %129, <16 x bfloat> %126, i32 1)
  %131 = tail call noundef <8 x i64> @llvm.aie2.bf.mul16.conf(<32 x bfloat> %128, <32 x bfloat> %130, i32 60)
  %132 = tail call noundef <16 x bfloat> @llvm.aie2.v16accfloat.to.v16bf16(<8 x i64> %131)
  %133 = getelementptr bfloat, ptr %9, i20 %76
  store <16 x bfloat> %132, ptr %133, align 32, !tbaa !12
  %134 = add nsw i32 %16, -32
  %135 = icmp eq i32 %134, 0
  br i1 %135, label %14, label %15, !llvm.loop !25
}

...
void dut(bfloat16 *restrict v1, bfloat16 *restrict v2) {
  ...
  v8accfloat v7_roll = *(v8accfloat *)(v1 + v3);
  //prolog 1

  v8accfloat v7 = v7_roll;

  v7_roll = *(v8accfloat *)(v1 + v3 + v5);

  v8accfloat input_bf16 = v7;

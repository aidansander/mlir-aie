; Produced using opt -O3 on lowered.ll
; ModuleID = 'lowered.ll'
...
define void @dut(ptr nocapture readnone %0, ptr %1, i64 %2, i64 %3, i64 %4, ptr nocapture readnone %5, ptr %6, i64 %7, i64 %8, i64 %9) local_unnamed_addr {
